		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cargo Calculator",
									"targetURL": "#comapptesting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapptesting-display": {
								"semanticObject": "comapptesting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.testing",
									"url": sap.ui.require.toUrl("com/app/testing")
								}
							}
						}
					}
